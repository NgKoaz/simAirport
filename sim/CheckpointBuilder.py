...
class CheckpointBuilder:
    ...
    def build(self, env: simpy.Environment):
        return {
            ...
            "boarding": [Checkpoint(env, numStaff, serviceTime, isFirstClass) for (isFirstClass, numStaff, serviceTime) in self.boardingCps],
        }
    ...
    def addBoardingCps(self, isFirstClass: bool, numStaff: int, serviceTime: float) -> 'CheckpointBuilder':
        self.boardingCps.append((isFirstClass, numStaff, serviceTime))
        return self
